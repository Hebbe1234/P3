...
using NorthernWinterBeat.Pages.VenueRazor;
...
{
    public class UnitTestIndexVenue
    {
        ...
        public void SortConcertsBy_CorrectlySortByArtist()
        {
            ...
            IndexVenueModel p1 = new IndexVenueModel(mockFestivalManager.Object)
            {
        ...
        public void SortConcertsBy_CorrectlySortByCapacity()
        {
            ...
            Assert.Equal(4, resultConcerts[1].ID);
            Assert.Equal(0, resultConcerts[2].ID);
            Assert.Equal(2, resultConcerts[3].ID);
            Assert.Equal(1, resultConcerts[4].ID);
        }
    }
}
